...
/// beyond the first k elements.Return k after placing the final result in the first k slots of nums.
...
class Program
{
    ...
    {
        HashSet<int> uniq = new HashSet<int>(nums);
        var uniqArr = uniq.ToArray();
